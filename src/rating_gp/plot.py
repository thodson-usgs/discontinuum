...
class RatingPlotMixin(BasePlotMixin):
    ...
    @is_fitted
    def plot_rating(self, covariates: Dataset, ci: float = 0.95, ax: Optional[Axes] = None, **kwargs):
    ...
    @is_fitted
    def plot_stage(self, covariates: Dataset = None, ax: Optional[Axes] = None, **kwargs):
    ...
    @is_fitted
    def plot_discharge(self, covariates: Dataset = None, ci: float = 0.95, ax: Optional[Axes] = None):
    ...
    @is_fitted
    def add_time_colorbar(self, ax: Optional[Axes] = None, time_ticks: Optional[list[Union[str, datetime]]] = None, **kwargs):
    ...
    def plot_ratings_in_time(
        self, time: Optional[list[Union[str, datetime]]] = None, ci: Optional[int] = 0, ax: Optional[Axes] = None, **kwargs
    ):
        """Plot predicted discharge versus stage.
